...
export const PROPOSE_WIZARD_STEPS: ProposeWizardStep[] = [
  {
    ...
    lede: "Name it and pick bounty or campaign.",
  },
  {
    id: "scope",
    label: "Scope",
    ...
    lede: "What ships, and how reviewers say yes.",
  },
  {
    id: "funding",
    label: "Funding",
    ...
    lede: "Optional target and milestones.",
  },
  {
    id: "context",
    label: "Links",
    ...
    lede: "Optional. Skip if nothing else.",
  },
  {
    id: "review",
    label: "Review",
    short: "5",
    title: "Review & submit",
    lede: "Check the draft, then pay the fee.",
  },
];
